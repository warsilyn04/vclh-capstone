...
<div class="row d-flex justify-content-center mt-5">
                        ...
                        @if (count($rooms) > 0)
                            @foreach ($rooms as $room)
                                <tr>
                                    ...
                                    <td>{{$room->freebie->freebie}}</td>
                                    <td>{{($room->status == 1) ? 'active' : 'inactive'}}</td>
                                    <td>
                                        <a href="/admin/rooms/{{$room->id}}" class="btn btn-success">Show</a>
                                        
                                    </td>
                                    <td>
                                        <a href="/admin/rooms/{{$room->id}}/edit" class="btn btn-success">Edit</a>
    ...
    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addNewTransaction">Add New Transaction</button>
    <div class="row mt-3">
        <div class="col-sm-12 col-xl-12">
            <div class="bg-secondary rounded h-100 p-4">
...
<div class="modal-dialog">
  <div class="modal-content bg-secondary">
   ...
   <!-- Modal -->
   <div class="modal fade" id="addNewTransaction" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content bg-secondary">
        <div class="modal-header">
