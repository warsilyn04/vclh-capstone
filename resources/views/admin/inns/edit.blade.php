...
<div class="container-fluid mt-5">
    <div class="row d-flex justify-content-center">
        <div class="col-sm-6  bg-secondary p-5 rounded">
            <form action="/admin/inns/{{$inn->id}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="room_image" class="form-control" value="{{$inn->room_image}}" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
