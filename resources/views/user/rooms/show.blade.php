@extends('layout.app')
@section('content')
    <a href="/user/rooms-manager" class="btn btn-outline-primary mt-5 ms-5">Back</a>
                            ...
                            @if (count($room_rates) > 0)
                                @foreach ($room_rates as $room_rate)
                                    <tr>
                                        ...
                                        <td scope="row">
                                            <a href="/user/room-rates-manager/{{ $room_rate->id }}/edit"
    ...
    <!-- Modal -->
    <div class="modal fade" id="addNewRoomRate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-content bg-secondary">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <form action="{{ route('room-rates-manager.store') }}" method="post">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="rate" class="form-control" id="exampleInputEmail1"
